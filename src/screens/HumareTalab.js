...
const screenHeight=Dimensions.get('screen').height;
    return (
        ...
        <TouchableOpacity style={{justifyContent:'center',alignItems:'center'}} onPress={() => navigation.navigate('CitizenScience')}>
        ...
        <Text style={{color:'#000',fontSize:18,justifyContent:'center',fontFamily:'Outfit-Medium'}}>Humare Talab, Humari Dharovar</Text>
        </View>
