...
const screenHeight=Dimensions.get('screen').height;
    return (
        ...
        <Text style={{color:'#000',fontSize:18,justifyContent:'center',fontFamily:'Outfit-Medium'}}>Outreach of water footprint campaign</Text>
        </View>
