...
const screenHeight=Dimensions.get('screen').height;
    return (
        ...
        <TouchableOpacity style={{justifyContent:'center',alignItems:'center'}} onPress={() => navigation.navigate('CleanTechnologies')}>
        ...
        <Text style={{color:'#000',fontSize:18,justifyContent:'center',fontFamily:'Outfit-Medium'}}>Moradabad-Metalware</Text>
        </View>
        ...
        <View style={{marginTop:100}}>
           ...
           <TouchableOpacity style={{alignItems: 'center',flexDirection:'row'}}>
              <Image
                ...
                source={require('../assets/cunter_current_mechanism.png')} />
              <Text
                style={{
                  color: '#fff',
                  fontSize: 14,
                ...
                Cunter current mechanism
              </Text>
              <TouchableOpacity 
                onPress={() => navigation.navigate('CounterCurrent')}>
                  <Image style={{height:30,width:30,marginBottom:10,marginLeft:-15}} source={require('../assets/next_button.png')}/>
                </TouchableOpacity>
