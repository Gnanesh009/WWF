...
const screenHeight=Dimensions.get('screen').height;
    return (
        ...
        <Text style={{color:'#000',fontSize:18,justifyContent:'center',fontFamily:'Outfit-Medium'}}>Kanpur - Leather</Text>
        </View>
        ...
        <View style={{marginTop:100}}>
           ...
           <TouchableOpacity style={{alignItems: 'center',flexDirection:'row'}}>
              <Image
                ...
                source={require('../assets/leathers_buyers_group.png')} />
              <Text
                style={{
                  color: '#fff',
                  fontSize: 14,
           ...
           <TouchableOpacity style={{alignItems: 'center',flexDirection:'row'}}>
              ...
              <TouchableOpacity 
                onPress={() => navigation.navigate('Iot')}>
                  <Image style={{height:30,width:30,marginBottom:10,marginLeft:70}} source={require('../assets/next_button.png')}/>
                </TouchableOpacity>
