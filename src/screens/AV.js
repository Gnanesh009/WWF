...
const screenHeight=Dimensions.get('screen').height;
    return (
        ...
        <TouchableOpacity style={{justifyContent:'center',alignItems:'center'}} onPress={() => navigation.navigate('CounterCurrent')}>
        ...
        <Text style={{color:'#000',fontSize:18,justifyContent:'center',fontFamily:'Outfit-Medium'}}>AV / Dataset</Text>
        </View>
