...
const screenHeight=Dimensions.get('screen').height;
    return (
        ...
        <TouchableOpacity style={{justifyContent:'center',alignItems:'center'}} onPress={() => navigation.navigate('UrbanRiverManagementPlans')}>
        ...
        <Text style={{color:'#000',fontSize:18,justifyContent:'center',fontFamily:'Outfit-Medium'}}>Barielly</Text>
        </View>
