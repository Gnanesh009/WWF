  ...
  return (
    ...
    <ImageBackground
      ...
      <SafeAreaView style={{flex:1 }}>
        ...
        <Text style={{color:"black",fontSize:18,fontWeight:'500',justifyContent:'center',fontFamily:'Outfit-Medium'}}>Real world wildlife products</Text>
        </View>
