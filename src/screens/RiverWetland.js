...
const screenHeight=Dimensions.get('screen').height;
    return (
        ...
        <View >
        <View style={{height:'40%',marginTop:-199,backgroundColor:'#4D979A',borderBottomLeftRadius:45,borderBottomRightRadius:45}}>
        ...
        <Text style={{color:'#fff',fontSize:18,justifyContent:'center',fontFamily:'Outfit-Medium'}}>River Wetland Co-management Urban</Text>
        </View>
        ...
        <View style={{marginTop:100}}>
           ...
           <TouchableOpacity style={{alignItems: 'center',flexDirection:'row'}}>
              <Image
                ...
                source={require('../assets/Rural.png')} />
              <Text
                style={{
                  color: '#000',
                  fontSize: 15,
              ...
              <TouchableOpacity 
                onPress={() => navigation.navigate('Rural')}>
        ...
        <View style={{ flexDirection:'row-reverse',marginHorizontal:20,marginTop:60}}>
