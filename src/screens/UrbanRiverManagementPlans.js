...
const screenHeight=Dimensions.get('screen').height;
    return (
        ...
        <Text style={{color:'#000',fontSize:18,justifyContent:'center',fontFamily:'Outfit-Medium'}}>Urban river management plans</Text>
        </View>
        ...
        <View style={{marginTop:100}}>
           ...
           <TouchableOpacity style={{alignItems: 'center',flexDirection:'row'}}>
              ...
              <TouchableOpacity 
                onPress={() => navigation.navigate('Moradabad')}>
                  <Image style={{height:30,width:30,marginBottom:10,marginLeft:-1}} source={require('../assets/next_button.png')}/>
                </TouchableOpacity>
           ...
           <TouchableOpacity style={{alignItems: 'center',flexDirection:'row'}}>
              ...
              <TouchableOpacity 
                onPress={() => navigation.navigate('Barielly')}>
        ...
        <View style={{ flexDirection:'row-reverse',marginHorizontal:20,marginTop:25}}>
