...
const MoradabadSpecific = ({navigation})=>{
...
const screenHeight=Dimensions.get('screen').height;
    return (
        ...
        <TouchableOpacity style={{justifyContent:'center',alignItems:'center'}} onPress={() => navigation.navigate('eflows')}>
        ...
        <Text style={{color:'#000',fontSize:18,justifyContent:'center',fontFamily:'Outfit-Medium'}}>Moradabad specific</Text>
        </View>
...
export default MoradabadSpecific;